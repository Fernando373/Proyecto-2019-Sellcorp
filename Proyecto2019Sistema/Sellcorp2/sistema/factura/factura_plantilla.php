...
<div id="page_pdf">
	<table id="factura_head">
		<tr>
			...
			<td class="info_empresa">
				<div>
					<span class="h2">SISTEMA VENTAS SELLCORP SRL</span>
					<p>Avenida las américas Zona 13, El Alto</p>
					<p>Teléfono: +(591) 75843452</p>
					<p>Email: momosunifranz@gmail.com</p>
				</div>
			</td>
			<td class="info_factura">
				<div class="round">
					...
					<p>Hora: 10:30am</p>
					<p>Vendedor: Fernando Murguia Estrada</p>
				</div>
			</td>
		</tr>
	</table>
				...
				<div class="round">
					...
					<table class="datos_cliente">
						...
						<tr>
							...
							<td><label>Dirección:</label> <p>10 Obrajes </p></td>
						</tr>
					</table>
				</div>
			</td>
	...
	<table id="factura_detalle">
			...
			<tfoot id="detalle_totales">
				...
				<tr>
					<td colspan="3" class="textright"><span>IVA (13%)</span></td>
					<td class="textright"><span>516.67</span></td>
				</tr>
				<tr>
