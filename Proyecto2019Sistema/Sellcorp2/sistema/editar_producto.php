...
<body>
	...
	<section id="container">
        ...
        <div class="form_register">
                   <h1><i class="far fa-cubes"></i> Actualizar productos </h1>
                   <hr>
              ...
              <input type="text" name="producto" id="producto" placeholder="Nombre del producto" onkeypress="return sololetras(event)" onpaste="return false" value=" <?php echo $data_producto['descripcion']; ?>">
              <label for="precio"> Precio </label>
                   <input type="text" name="precio" id="precio" placeholder="precio" onkeypress="return solonumeros(event)" onpaste="return false" value=" <?php echo $data_producto['precio']; ?>">
