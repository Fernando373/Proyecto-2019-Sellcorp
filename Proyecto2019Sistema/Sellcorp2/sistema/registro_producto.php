...
<body>
	...
	<section id="container">
        ...
        <div class="form_register">
                   <h1><i class="far fa-cubes"></i> Registro de productos </h1>
                   <hr>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                   ...
                   <input type="number" name="cantidad" id="cantidad" placeholder="Cantidad del producto" onkeypress="return solonumeros(event)" onpaste="return false">
