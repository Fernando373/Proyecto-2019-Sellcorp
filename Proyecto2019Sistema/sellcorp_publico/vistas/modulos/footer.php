		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 text-left infoContacto">
				...
				<h5>
					...
					<i class="fa fa-phone-square" aria-hidden="true"></i> (591) 762-75-987

					<br><br>

					<i class="fa fa-envelope" aria-hidden="true"></i> sellcorp@gmail.com

					<br><br>

					<i class="fa fa-map-marker" aria-hidden="true"></i> San Miguel
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6 col-xs-12 text-left text-muted">
				...
				<h5>&copy; 2019 Todos los derechos reservados. Sitio elaborado por David Pinto</h5>
